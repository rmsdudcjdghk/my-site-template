...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교","period":"2022~","description":"경영학과, 통계데이터사이언스학과"},{"icon":"briefcase","title":"단국대학교 단과대대의원 1학년대표","period":"2022","description":" "},{"icon":"user","title":"병역의무","period":"2023.04~2024.10","description":" 대한민국 해병대 병장 만기전역"},{"icon":"briefcase","title":"제 21대 대선 국민의힘 홍보특보","period":"2025.05.23~2025.06.03","description":" "},{"icon":"trophy","title":"단국대학교 성적우수상","period":"2025.07.04","description":" "},{"icon":"award","title":"ADsP : 데이터분석 준전문가","period":"2025.09.05","description":" "},{"icon":"award","title":"Google AI Essential 수료","period":"2025.09.06","description":" "},{"icon":"lightbulb","title":"KYWA 제 2회 청소년 데이터분석 공모전","period":"2025.11","description":" "},{"icon":"award","title":"TOEIC 770","period":"564회차","description":" "},{"icon":"briefcase","title":"비트세이빙 서포터즈 2기","period":"2026.03.16~2026.05.10","description":" "},{"icon":"briefcase","title":"피트스탁 베타테스터","period":"2026.04~2026.05","description":" "},{"icon":"briefcase","title":"(주)플러스인씨앤씨","period":"2026.07~","description":" 인턴"}],
    skills: [],
    storyTitle: "나의 이야기",
    story: ["저는 기술을 통해 사람들의 삶을 더 편리하고 의미 있게 만드는 일에 열정을 가지고 있습니다.","경영학과를 주전공하며 시장과 기업의 문제 구조를 이해하고, 통계데이터사이언스 학과를 복수전공하며 데이터 기반의 의사결정 역량을 키우고 있습니다.","요즘은 빠른 시대변화에 발맞춰, 코딩을 하거나 문제해결이 필요할 때 AI 도구를 활용하여 초안을 빠르게 도출하고, 이를 검수 및 개선하는 방식으로 속도와 완성도를 높이고있습니다."],
